...
| **A** | `b0` | зарезервирована, действие временно отключено |
| **B** | `b1` | raw-кнопка; клик (touch down/up) в фиксированной точке `(35,345)` |
| **Y** | `b2` | raw-кнопка; touch down при нажатии и up при отпускании в `(37,287)`, как A |
| **L2** | `b10` | клик (touch down/up) в фиксированной точке `(541,446)` |
| **L1** | `b4` | свайп влево (уклонение) |
| **R1** | `b5` | свайп вправо (уклонение) |
| **R2** | `b11` | в гироскопе fire (pid 723), в режиме курсора — A-подобный touch в позиции курсора |
| **X** | `b3` | зарезервировано |
...
- Проверено: логотип (со звуком), стабильный рендер, курсор движется
  стиком/крестовиной, A — тап, B — фиксированный клик. Переход в главное меню иногда
