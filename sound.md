...
Статус: **ЗВУК РАБОТАЕТ** (музыка/звуки/диалоги). Две проблемы найдены и
исправлены: (1) `FMOD_ERR_FILE_EOF(22)` при загрузке FEV из-за bionic `_flags`;
(2) «шум в динамиках и скип диалогов» из-за того, что FSB-банки лежали не в
каталоге FEV. Игра стабильно рендерит и озвучивается, крашей нет.
...
## 4. Текущее состояние: FEV грузится, но звука нет (шум, скип диалогов)
...
## 6. ИТОГ — что было сделано (сводка)
